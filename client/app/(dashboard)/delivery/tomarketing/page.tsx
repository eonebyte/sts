...
export default function Page() {
    ...
    const fetchShipments = async (authToken: string) => {
        setLoading(true);
        try {
            const res = await fetch(`${API_BASE_URL}/shipments/comebacktomarketing`, {
    ...
    const handleHandoverConfirm = async () => {
        ...
        const payload = {
            ...
            status: "HO: DEL_TO_MKT", // Sesuaikan statusnya
            user_id: parseInt(user.user_id),
            notes: 'handover delivery to marketing'
        };
                ...
                <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
                    ...
                    <DialogContent className="sm:max-w-[400px]">
                        <DialogHeader>
                            ...
                            <DialogDescription>
                                Anda akan memproses handover untuk {selectedRowsData.length} surat jalan ke bagian Marketing.
                            </DialogDescription>
                        </DialogHeader>
