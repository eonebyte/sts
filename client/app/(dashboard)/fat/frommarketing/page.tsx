...
export default function ReceiptPage() {
    ...
    const fetchShipments = async (authToken: string) => {
        ...
        try {
            ...
            const res = await fetch(`${API_BASE_URL}/shipments/receiptcomebacktofat`, {
    ...
    const handleReceiptConfirm = async () => {
        ...
        const payload = {
            ...
            status: "RE: FAT_FROM_MKT", // Status baru
            user_id: parseInt(user.user_id),
            notes: "receipt fat from marketing" // Notes sesuai permintaan
        };
